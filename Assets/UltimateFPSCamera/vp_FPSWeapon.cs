...
public class vp_FPSWeapon : vp_Component
{
	...
	{
		Debug.LogError("Error: No child GameObject with a weapon camera found under this FPSCamera. This will cause a crash. See the Ultimate FPS Camera manual for setup details.");
	}
